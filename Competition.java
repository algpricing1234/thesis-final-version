...
abstract class Competition {
    ...
    /**
     * @param numberOfFirms number of all competing firms
     * @return the scaled profit in the Nash equilibrium for the corresponding number of all competing firms
     */
    public abstract double getScaledProfitInNashEquilibrium(int numberOfFirms);
    ...
    public abstract double getScaledProfitInJpmEquilibrium(int numberOfFirms);
    /**
    ...
    void calculateData(int independentVariable, Integer[] independentVariablesOfOtherFirms) {
        //System.out.println("independentVariableOwn: " + independentVariable + ", independentVariableOthers: "+ independentVariablesOfOtherFirms[0] + ", "+ independentVariablesOfOtherFirms[1]);
        ...
        //System.out.println("independentVariable: " + independentVariable + ", dependentVariable: "+ this.getDependentVariable() + ", profit: "+ profit);
